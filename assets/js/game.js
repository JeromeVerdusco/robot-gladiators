...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        // ask playerif they'd like to fight or run
        if (fightOrSkip()) {
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
                // ask if player wants to use the store befoore the next round
    ...
    // after loop ends, we are out of something so run endGame
    endGame();
};
...
var shop = function() {
    ...
    shopOptionPrompt = parseInt(shopOptionPrompt);  //this makes the number after 'case' an integer instead of a string.
